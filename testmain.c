...
/*   Updated: 2020/10/16 12:09:59 by eprusako         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// Processing the rule 'all' twice in a row should result in nothing to be done
// Bonuses still have leaks
// Fix the norm once again
    ...
    Test 2051 (bonus_notrequired_f_reserved_values_inf_6was) : FAILED.
...
Test 2061 (bonus_notrequired_f_reserved_values_inf_sp_prec7) : FAILED.
    First line of code: {double special; *((unsigned long *)(&special)) = DBL_INF;
      expected output : " inf"
      your output     : "inf"
      expected (nonprintable as hex) : " inf"
...
Test 2066 (bonus_notrequired_f_reserved_values_inf_sp) : FAILED.
    First line of code: {double special; *((unsigned long *)(&special)) = DBL_INF;
      expected output : " inf"
      your output     : "inf"
      expected (nonprintable as hex) : " inf"
    ...
    */
    ...
    // ft_printf("FT 0.15|%#.5e|\n", 0.15);
    // printf("PF 0.15|%#.5e|\n", 0.15);
    //  int a = ft_printf("FT %%g = |%g|\n", 42);
    //  int b = printf("PF %%g = |%g|\n", 42);
    //  assert(a == b);
    //  ft_n(1);

 //   ft_printf("FT 0.555|%.2g|\n", 0.555);
 //   printf("PF 0.555|%.2g|\n", 0.555);
   // ft_printf("FT %%g = |%g|\n", 42);
   // printf("FT %%g = |%g|\n", 42);
    //ft_printf("FT %%d LONG_MIN |%*0ld|\n", 35, LONG_MIN);
   // ft_printf("%-7s%5s", "hello", "world");

    // ft_printf("FT %%d LONG_MIN |%035ld|\n", LONG_MIN);
    // ft_printf("FT %%d LONG_MIN |%035ld|\n", LONG_MIN - 1);
    // printf("FT %%d LONG_MIN |%035ld|\n", LONG_MIN - 1);
    // //ft_printf("FT   %%.10Lf, 0.87650894255l |%.10Lf|\n", 0.87650894255l);
    //ft_printf("FT %%X = |%X|\n", 42);
    // ft_printf("FT %%x = |%x|\n", 42);
    // printf("FT %%x = |%x|\n", 42);

    // Corrupt value: 0x70336f45514c6466
    //pftest(27306,0x115d7c5c0) malloc: *** set a breakpoint in malloc_error_break to debug
    //zsh: abort      ./pftest 1
